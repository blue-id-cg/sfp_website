<!-- ===== NAVIGATION LATÉRALE (scrollspy · homepage) ===== -->
<nav class="spy" id="spy" aria-label="Navigation rapide">
    ...
    <a href="#contact" data-spy="contact"><span class="dot"></span><span class="lbl">Contact</span></a>
</nav>
