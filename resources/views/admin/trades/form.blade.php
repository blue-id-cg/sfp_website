...
<x-admin.field name="description" label="Description courte" hint="Affichée sur la carte de la liste des métiers.">
    <textarea name="description" id="description" rows="3" class="@error('description') invalid @enderror">{{ old('description', $trade->description ?? '') }}</textarea>
</x-admin.field>

<x-admin.field name="body" label="Description détaillée" hint="Affichée sur la page dédiée du métier.">
...
<div class="mt-6 flex items-center gap-3">
    ...
    <a href="{{ route('admin.trades.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Annuler</a>
</div>
