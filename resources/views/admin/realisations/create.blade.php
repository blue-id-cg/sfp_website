<x-app-layout>
    <x-slot name="header">Nouvelle réalisation</x-slot>

    <x-admin.page-header title="Nouvelle réalisation" />

    <div class="form-card max-w-lg">
        <form method="POST" action="{{ route('admin.realisations.store') }}" enctype="multipart/form-data">
