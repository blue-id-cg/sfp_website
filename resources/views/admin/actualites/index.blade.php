<x-app-layout>
    ...
    <x-admin.search value="{{ $search }}" placeholder="Rechercher une actualité…" class="mb-5" />
                ...
                @forelse ($actualites as $actualite)
                    <tr class="hover:bg-gray-50/60">
                        ...
                        <td class="px-4 py-3 text-right space-x-3">
                            ...
                            <form method="POST" action="{{ route('admin.actualites.destroy', $actualite) }}" class="inline" data-confirm data-confirm-title="Supprimer cette actualité ?" data-confirm-message="Cette actualité sera définitivement supprimée.">
                                @csrf
                                @method('DELETE')
