<!-- ===== ÉQUIPEMENTS ===== -->
<section id="equipements" class="section bg-industrial">
    <div class="wrap">
        <div class="sec-head-split mb-4">
            ...
            <div class="r reveal">
                <p class="lead">Deux rigs, le MR-8000 Drillmec (1080 HP) et le MR-3500, ainsi qu'une base opérationnelle de 30 000 m² à Djeno pour la réception, le stockage et l'entretien des équipements avant leur déploiement sur site.</p>
            </div>
        </div>
