...
<section id="hse" class="section bg-industrial">
    <div class="wrap">
        <div class="sec-head-split mb-4">
            ...
            <div class="r reveal">
                <p class="lead">Notre engagement pour la santé, la sécurité et l'environnement est non négociable. C'est le fondement de notre culture d'entreprise et la condition de chaque opération.</p>
            </div>
        </div>
        ...
        <div class="hse-metrics reveal mt-5" role="list">
            <div role="listitem"><b>EPI</b><span>Obligatoires sur l'ensemble des sites d'intervention</span></div>
            <div role="listitem"><b>Briefing</b><span>Point sécurité systématique avant chaque opération</span></div>
            <div role="listitem"><b>Audits</b><span>Contrôles et bonnes pratiques régulièrement vérifiés</span></div>
            <div role="listitem"><b>Zéro</b><span>Objectif zéro incident, non négociable</span></div>
        </div>
    </div>
</section>
