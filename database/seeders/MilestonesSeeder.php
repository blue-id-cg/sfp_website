...
class MilestonesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $entries = [
            ...
            ['year_label' => '2011', 'category' => 'Premières opérations', 'title' => 'Démarrage sur le marché MKB', 'description' => 'La SFP démarre ses opérations en septembre 2011 sur le premier marché Mengo-Kundji-Bindi (MKB) attribué à la SNPC.'],
